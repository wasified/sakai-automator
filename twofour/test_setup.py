...
COURSE_NAME = "VJ101"
URL = "https://trunk-mysql8.nightly.sakaiproject.org/portal/"
...
def test_add_users(playwright: Playwright) -> None:
    ...
    # move to admin workspace
    #page.get_by_role("link", name="Administration Workspace").click()
    page.locator("#content").get_by_role("link", name="Administration Workspace").click()
